  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li><a href="guidely.html"><i class="icon-facetime-video"></i><span>Produk</span> </a></li>
		<li><a href="reports.html"><i class="icon-list-alt"></i><span>Penjualan</span></a></li>
        <li><a href="charts.html"><i class="icon-bar-chart"></i><span>Sales</span> </a> </li>
        <li><a href="shortcodes.html"><i class="icon-code"></i><span>Agen</span> </a> </li>
        <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-long-arrow-down"></i><span>Laporan</span> <b class="caret"></b></a>
          ...
          <div class="widget">
            ...
            <div class="widget-content">
              <ul class="messages_layout">
                <li class="from_user left"> <a href="#" class="avatar"><img src="<?=base_url();?>assets/genchan/img/message_avatar1.png"/></a>
                ...
                <li class="by_myself right"> <a href="#" class="avatar"><img src="<?=base_url();?>assets/genchan/img/message_avatar2.png"/></a>
                  <div class="message_wrap"> <span class="arrow"></span>
                ...
                <li class="from_user left"> <a href="#" class="avatar"><img src="<?=base_url();?>assets/genchan/img/message_avatar2.png"/></a>
                  <div class="message_wrap"> <span class="arrow"></span>
